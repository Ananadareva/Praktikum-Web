...
INSERT INTO `files` (`id`, `post_id`, `fileName`, `url`, `created_at`, `updated_at`) VALUES
(9, 22, 'createPost.png', 'post_images/createPost.png', '2024-01-01 18:32:00', '2024-01-01 18:32:00'),
(10, 22, 'editPostBerhasil.png', 'post_images/editPostBerhasil.png', '2024-01-01 18:32:00', '2024-01-01 18:32:00'),
(11, 1, 'dw.jpg', 'post_images/dw.jpg', '2024-01-23 01:50:56', '2024-01-23 01:50:56'),
(12, 1, 'Ektm.jpeg', 'post_images/Ektm.jpeg', NULL, NULL),
(13, 1, 'LogoUp.png', 'post_images/LogoUp.png', '2024-01-02 01:53:21', '2024-01-02 01:53:21');
...
(5, '2023_12_27_083337_create_profiles_table', 2);
...
(22, 11, 'Coba Files', 'Coba file 123', 0, '2024-01-01 18:32:00', '2024-01-01 18:32:00');
...
INSERT INTO `profiles` (`id`, `user_id`, `jenis_kelamin`, `tanggal_lahir`, `negara`, `biografi`, `url`, `created_at`, `updated_at`) VALUES
(1, 11, 'P', '2013-12-01', 'Cuba', 'Edit Profile 3', 'post_images/candra.png', '2023-12-03 08:37:25', '2024-01-04 08:52:24');
...
(11, 'admin', 'admin@gmail.com', '2023-09-10 06:58:03', '$2y$10$kv/Wj3E4PFBX1Naay51FkeBA3L5YD6nqgbj9u5Fyh01ODoPOa047K', NULL, '2023-12-21 08:18:24', '2023-12-12 08:18:24', NULL);
...
--
ALTER TABLE `files`
  ADD CONSTRAINT `files_post_id_foreign` FOREIGN KEY (`post_id`) REFERENCES `posts` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
